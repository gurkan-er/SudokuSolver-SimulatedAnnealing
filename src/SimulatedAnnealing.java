public class SimulatedAnnealing {
    private final Sudoku givenSudoku;
    ...
    public SimulatedAnnealing(Sudoku givenSudoku,
                              double temperature, double temperatureMinimum,
                              double coolingRate, int maxIterations) {
        this.givenSudoku = givenSudoku;
        this.bestSudoku = givenSudoku.duplicate();
    ...
    public void run_FirstApproach() {
        Sudoku currentSudoku = this.givenSudoku.duplicate();

        int numberOfError_bestSudoku = bestSudoku.lossFunctionScore();
        // First Approach
        /*
        if we control numberOfError_bestSudoku in a while,
    ...
    public int getNumberOfError_bestSudoku() {
        return bestSudoku.lossFunctionScore();
    }
